...
let items = [
  ...
  },
  {
    ...
    description: 'High-speed portable solid-state drive with USB-C',
    price: 139,
    category: 'Storage',
    brand: 'DataVault',
    stock: 88,
  ...
  },
  {
    id: 10,
    name: 'Monitor 27" 4K',
    description: 'Ultra HD 4K monitor with HDR and USB-C connectivity',
    price: 549,
    category: 'Displays',
    brand: 'ViewMax',
    stock: 23,
  ...
  },
  {
    ...
    description: 'Extended RGB gaming mouse pad with wireless charging',
    price: 45,
    category: 'Accessories',
    brand: 'GameZone',
    stock: 203,
  ...
  },
  {
    id: 12,
    name: 'Desk Lamp LED',
    description: 'Smart LED desk lamp with adjustable brightness and temperature',
    price: 69,
    category: 'Office',
    brand: 'LightWorks',
    stock: 112,
  ...
  },
  {
    id: 22,
    name: 'Tablet 10" Pro',
    description: 'High-performance tablet with stylus and keyboard support',
    price: 599,
    category: 'Tablets',
    brand: 'TechTab',
    stock: 28,
